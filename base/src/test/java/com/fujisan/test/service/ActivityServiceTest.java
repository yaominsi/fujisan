...
public class ActivityServiceTest extends BaseTest{
	private static final Logger log=Logger.getLogger(ActivityServiceTest.class);
	private ActivityService service;
	
	@Test
	public void testCreate() {
		service=context.getBean(ActivityService.class);
		...
		ActivityModel model=new ActivityModel("54d24360a8260fe5537e57f0","title",new Date(),new Date());
